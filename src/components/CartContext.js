...
// useEffect(() => {
//   // Check if the cart modal should be open based on a value from local storage
//   const shouldOpenCartModal = localStorage.getItem('openCartModal') === 'true';
//   setIsCartOpen(shouldOpenCartModal);
// }, []);
